...
public class InternalConsultaGarcons extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listagem Garçons Cadastrados");
    ...
    private void ButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonExcluirActionPerformed
        ...
        try {
            ...
            String idExcluir = JOptionPane.showInputDialog("Confirme o ID do garçom que deseja Excluir!");
            int idGarcom = Integer.parseInt(idExcluir);
        
            IGarcomNegocio garcomNegocio = new GarcomNegocio();
            boolean isSucesso = garcomNegocio.excluirGarcom(idGarcom);
